...
$sql = mysqli_query($conn, " INSERT INTO `eshop`.`productlist` (`productname`, `price`, `prodescrip`, `qty`, `catagoryid`, `subcatagoryid`, `minqty`, `maxqty`, `activestatus`, `pimage`) VALUES ('$pname', '$price', '$prdesc', '$qty', '$cat', '$subcat', '$mini', '$max', '$activestatus','$fileToUpload')");
?>
<script>alert("Product Added");</script>
<script>window.location.href='pf.php';</script>