...
<html lang="en">
  <head>
    ...
    <title> Sub Catagory list Iem</title>
    <style>
      a{
        color:white;
      }
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Sub Catagory List Item</a>
  ...
  <?php 
    ...
    while($row= mysqli_fetch_array($result)){
      ...
      <td><button class='btn btn-sm btn-primary'><a href='subedit.php?id=".$row['sno']."'>Edit</a></button> <button class='delete btn btn-sm btn-primary' onclick='myFunction()'><a href='subdelete.php?id=".$row['sno']."'>Delete</a></button> </td>
