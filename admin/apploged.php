                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="pl.php">Prodcts</a>
                                        </li>

                                        <li>
                                            <a href="pf.php">Add New Products</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="catagorylist.php">Category List</a>
                                        </li>
                                        <li>
                                            <a href="catagorymasterform.php">Add New Category</a>
                                        </li>
                                        <li>
                                            <a href="subcatagorylist.php">Sub Category</a>
                                        </li>
                                        <li>
                                            <a href="subcatform.php">Add New Sub Category</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav" href="changepassword.php">
                                        <i class="ri-home-line"></i>
